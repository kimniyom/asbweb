...
class background extends CI_Controller {
    ...
    public function index() {
        ...
        if (substr($background, 0, 1) == "#") {
            ...
            $data['background'] = "<img src='' class='img-responsive img-polaroi' style='height:150px; background:" . $background . "'/>";
        } else {
            $base = base_url();
    ...
    public function set_background() {
        ...
        if (substr($bg, 0, 1) == "#") {
            $data['background'] = "<img src='' class='img-responsive img-polaroid' style='height:150px; background:" . $bg . "'/>";
