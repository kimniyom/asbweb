...
<hr/>
<button type="button" class="btn btn-success pull-right" id="add_groupnew">
        ...
        foreach ($groupnews->result() as $rs):
            ...
            <tr>
                ...
                <td style=" text-align: center;">
                    <?php if ($rs->active == 1) { ?>
                        <input type="checkbox" id="active" name="active" class="form-control" checked="checked" onclick="set_unactive('<?php echo $rs->id ?>', '0')"/>
                    <?php } else { ?>
                        <input type="checkbox" id="active" name="active" class="form-control"  onclick="set_active('<?php echo $rs->id ?>', '1')"/>
                    <?php } ?>
                </td>
