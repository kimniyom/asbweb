...
<?php $i=1;foreach($icon->result() as $rs): ?>
    <div class="col-xs-3 col-sm-2 col-md-1 col-lg-1" style="margin-bottom: 20px;">
      <div class="btn btn-default btn-block" data-toggle="tooltip" data-placement="top" title="<?= $rs->icon ?>">
        <img src="<?= base_url() ?>icon_menu/<?= $rs->icon ?>" style="max-width:32px;"/>
      </div>
      <a href="javascript:delete_icon('<?php echo $rs->icon_id ?>')"><i class="fa fa-trash test-danger"></i></a>
    </div>
<?php endforeach; ?>
