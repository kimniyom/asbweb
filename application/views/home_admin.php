    ...
    <!-- User -->
        <?php if ($this->session->userdata('status') == 'S') { ?>
            <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <a href="<?= site_url('backend/users/show_user/') ?>" style=" text-decoration: none;">
                    <div class="btn btn-default btn-block">
                        <center>
                            <img src="<?= base_url() ?>icon_menu/user-group.png" class="img-responsive" style=" max-height: 80px;"/>
                            <br/>ผู้ใช้งาน
                        </center>
                    </div>
                </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="admin_menu_link" value="takmoph_admin/get_dengue" readonly style=" width: 95%;" class=" form-control"/>
