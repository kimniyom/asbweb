...
<div class="container">
	...
	?>
	<h3 id="head_submenu"><img src="<?php echo base_url()?>images/Album-icon.png" style="width:48px;"/> <?php echo $active ?></h3>
	<hr id="hr"/>
		...
		<div class="fb-share-button" data-href="<?php echo $shareUrl ?>" data-layout="button_count"></div>
			<center>
		<h4><?php echo $head ;?></h4>
		<p style="color:#999999;">รายละเอียด : <?php if(!empty($album->detail)){ echo $album->detail; } else { echo "-";} ?></p>
		<hr/>
</center>
	<div class="row">
			<?php
